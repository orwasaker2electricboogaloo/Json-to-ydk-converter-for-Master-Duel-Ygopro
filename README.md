A simple python script to convert json files, used in Master Duel, into ydk files for usage in offline simulators like Edopro, Ygopro, MD3pro and YgoOmega
